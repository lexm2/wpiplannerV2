...
- ScheduleController: 12C+D grids (ScheduleGrids/TermGrid — the term focus animation + conflict matrix + section blocks + generating overlay), 12E CalendarEventProvider standalone + delete controller. MainController shell (Phase 13: App.svelte root, LAST).
