...
### ⬜ Remaining work
- MainController shell (Phase 13: App.svelte root, LAST), then delete the `reactivity.svelte.ts` `watch` bridge once nothing imperative subscribes, and remove these `RUNES_MIGRATION*.md` files.
