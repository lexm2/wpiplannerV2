...
### ⬜ 13B–13D — remaining
- **13B** extract non-UI bootstrap out of MainController → `bootstrapApp()`; delete the dead `setupCourseSelectionListener`/`previousSelectedCoursesMap`/`updateSelectedCoursesState`.
