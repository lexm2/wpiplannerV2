...
const ROWS: string[][] = [
    ...
    ['WPI Total Credits Required - Undergraduate - 135 Credits', 'In Progress', 'Minimum 35.25 Credit(s)', 'CS 1102 - Accelerated Introduction To Program Design', '2025 Fall A Term', '3', 'A'],
    ['WPI Total Credits Required - Undergraduate - 135 Credits', 'In Progress', 'Minimum 35.25 Credit(s)', 'MA 1021 - Calculus I (Transfer Credit)', '', '3', 'L'],
    ['WPI Total Credits Required - Undergraduate - 135 Credits', 'In Progress', 'Minimum 35.25 Credit(s)', 'WPE 1601 - Insight Program', '2025 Fall Semester', '0.75', 'P'],
    ['WPI Total Credits Required - Undergraduate - 135 Credits', 'In Progress', 'Minimum 35.25 Credit(s)', 'CS 2022/ MA 2201 - Discrete Mathematics (In Progress)', '2026 Fall A Term', '3', ''],
    // Residency — CS 1102 (2nd of 3) for the dedupe/satisfies assertion.
    ['WPI Residency Requirement - Undergraduate - 72 Credits', 'In Progress', 'None', 'CS 1102 - Accelerated Introduction To Program Design', '2025 Fall A Term', '3', 'A'],
    // MQP — lets the parser derive major "Computer Science" + degree "BS".
    ['WPI Major Qualifying Project (Computer Science BS) Requirement - Undergraduate', 'Not Satisfied', 'Minimum Combination Required', '', '', '', ''],
    // Major-specific in-progress requirement — CS 1102 (3rd of 3).
    ['Computer Science - Core Requirement - Undergraduate - 36 Credits', 'In Progress', 'Minimum 6 Credit(s)', 'CS 1102 - Accelerated Introduction To Program Design', '2025 Fall A Term', '3', 'A'],
    // A satisfied major-specific requirement.
    ['Computer Science - Systems Requirement - Undergraduate - 3 Credits', 'Satisfied', 'None', 'CS 3013 - Operating Systems', '2026 Spring C Term', '3', 'A'],
    // The synthetic "Unused Courses" bucket the UI hides.
    ['Unused Courses - Successfully Completed - Undergraduate', 'Not Satisfied', 'Minimum 200 Credit(s)', '', '', '', ''],
];
...
console.log(`Wrote ${outPath} (${zip.length} bytes, ${strings.length} shared strings)`);
