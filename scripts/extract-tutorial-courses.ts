...
const targetIds = [
    'RBE-2001-2026', 'RBE-2002-2026', 'ETR-1100-2026', 'ES-2501-2026',
    'RBE-2020-2026', 'RBE-3001-2026', 'CS-3733-2026', 'HU-3900-2026',
    'RBE-3002-2026', 'ES-3001-2026', 'RBE-3100-2026', 'ES-3011-2026',
];
...
writeFileSync('./tutorial-course-sections.json', JSON.stringify(result, null, 2));
