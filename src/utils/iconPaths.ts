// Type-safe icon path constants and inline SVG content for Vite-resolved asset references.
...
// Icon paths mapped to SVG asset URLs.
...
// Inline SVG content for CSS-stylable icon references.
